...
a1 = Animal.create([{name: "Rhino"},{url: "#"},{vidURL: "https://www.youtube.com/embed/EHB_CM86rgk"},{threatLevel: "0"},{description: "Rhinos once roamed many places throughout Eurasia and Africa and were known to early Europeans who depicted them in cave paintings. Long ago they were widespread across Africa's savannas and Asia's tropical forests. But today very few rhinos survive outside national parks and reserves.
