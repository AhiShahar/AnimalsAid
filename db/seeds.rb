...
a4 = Animal.create name: "Hippopotamus",URL: "#",vidURL: "https://www.youtube.com/embed/EHB_CM86rgk",threatLevel: "0",description: "The hippo population declined most dramatically in the Democratic Republic of the Congo. By 2005, the population in Virunga National Park had dropped to 800 or 900 from around 29,000 in the mid-1970s. The decline is attributed to the disruptions caused by the Second Congo War. The poachers are believed to be Mai-Mai rebels, poorly paid Congolese soldiers, and local militia groups.
...
a6 = Animal.create name: "Tiger",URL: "#",vidURL: "https://www.youtube.com/embed/EHB_CM86rgk",threatLevel: "0",description: "The largest of all the Asian big cats, tigers rely primarily on sight and sound rather than smell. They typically hunt alone and stalk prey. A tiger can consume up to 88 pounds of meat at one time. On average, tigers give birth to two or three cubs every two years. If all the cubs in one litter die, a second litter may be produced within five months.
...
a15 = Animal.create name: "Snow Leopard",URL: "#",vidURL: "https://www.youtube.com/embed/EHB_CM86rgk",threatLevel: "0",description: "The sole predator of snow leopards? Humans. Hunting, habitat loss and retaliatory killings are the main reasons this big cat is now listed as an endangered species. Snow leopards are often killed by local farmers because they prey on livestock such as sheep, goats, horses, and yak calves. The animals which snow leopards would typically hunt—such as the Argali sheep—are also hunted by local communities. As their natural prey becomes harder to find, snow leopards are forced to kill livestock for survival.
...
a16 = Animal.create name: "Penguin",URL: "#",vidURL: "https://www.youtube.com/embed/EHB_CM86rgk",threatLevel: "0",description: "Commercial fishing in the Southern Ocean region can force many penguin species to compete for the fish they eat. The practice can also lead to accidental capture and drowning in fishing nets.
...
a17 = Animal.create name: "Polar Bear",URL: "#",vidURL: "https://www.youtube.com/embed/EHB_CM86rgk",threatLevel: "0",description: "Polar bears depend on sea ice as a platform from which to hunt seals, rest and breed. For more than 20 years the summer sea ice has been decreasing in size and melting for longer periods of time. Bears must move longer distances to stay with the rapidly receding ice.
...
a19 = Animal.create name: "Orca",URL: "#",vidURL: "https://www.youtube.com/embed/EHB_CM86rgk",threatLevel: "0",description: "Orcas are well known for their mental capabilities. Studies have indicated that an Orca has an outstanding memory, perhaps even photographic. In tests conducted with Orcas in captivity, they recalled testing patterns up to 25 years after they were initially conducted.
...
a20 = Animal.create name: "Blue Whale",URL: "#",vidURL: "https://www.youtube.com/embed/EHB_CM86rgk",threatLevel: "0",description: "Like other large whales, blue whales are threatened by environmental change including habitat loss and toxics. Blue whales can also be harmed by ship strikes and by becoming entangled in fishing gear. Although commercial whaling no longer represents a threat, climate change and its impact on krill (shrimp-like crustaceans), blue whales' major prey, makes this cetacean particularly vulnerable.
...
a21 = Animal.create name: "Great White Shark",URL: "#",vidURL: "https://www.youtube.com/embed/EHB_CM86rgk",threatLevel: "0",description: "Great white sharks are decreasing in numbers and are rare due to years of being hunted by man for fins and teeth, and often as a trophy for sport fishing. The white shark is often caught as bycatch by commercial fisheries and can also become entangled in meshes that protect beaches.
...
a23 = Animal.create name: "Dolphin",URL: "#",vidURL: "https://www.youtube.com/embed/EHB_CM86rgk",threatLevel: "0",description: "The Bottlenose Dolphin (Tursiops truncatus) is the most common species of dolphin, inhabiting warm and temperate seas worldwide. The world dolphin is adapted from the word delphis, which means 'a fish with a womb'.
